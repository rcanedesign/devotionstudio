...
<head>
<title>Article - Article Page | Fashion - Free Website Template from Templates.com </title>
...
<!-- header -->
				<div id="header">
					<div class="row-1">
						<ul class="top-nav">
							<li><a href="home.html"><img alt="" src="images/icon-home.gif" /></a></li>
							<li><a href="contact_us.html"><img alt="" src="images/icon-mail.gif" /></a></li>
							<li><a href="site_map.html"><img alt="" src="images/icon-map.gif" /></a></li>
						</ul>
						<form action="" id="search-form"><fieldset>website search &nbsp; <input type="text" value="" class="text" /></fieldset></form>
					</div>
					<div class="row-2">
						<div class="indent">
							<a href="home.html"><img alt="" src="images/logo.jpg" /></a>
						</div>
					</div>
					<div class="row-3">
						<ul class="site-nav">
...
<!-- content -->
				<div id="content">
					...
					<div class="img-box">
						...
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc ornare lobortis elit vel venenatis. Vivamus magna arcu, placerat in elementum quis, luctus et magna. Aenean pharetra ultrices nibh, eu tempor enim commodo eu. Mauris faucibus eros nec ligula molestie accumsan. Fusce tempus porttitor porta. In pellentesque suscipit ipsum nec tincidunt. Suspendisse eu risus ac felis commodo vehicula. Fusce placerat, nisl a pretium sollicitudin, odio ligula sagittis quam, vitae consectetur enim massa et urna.
					</div>
					...
					Pellentesque condimentum, eros a ornare eleifend, mi dui pretium elit, et tempor tortor turpis semper orci. Maecenas facilisis massa nec magna sagittis rhoncus id vitae elit. Pellentesque viverra aliquet arcu a sodales. Etiam in tincidunt nisl. Curabitur eget odio massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec semper tincidunt dui vel placerat. Phasellus vel eros euismod quam ultrices tristique molestie nec risus. Pellentesque nec eros mi, non molestie neque. In laoreet sollicitudin turpis. Praesent sed felis id enim egestas tristique ut feugiat leo. Quisque vel lorem fermentum nisi interdum venenatis non pretium nibh. Suspendisse potenti. Nunc tempus rutrum dui, ut pulvinar erat accumsan faucibus. 
					<div class="inner_copy">More <a href="http://www.templates.com/">Website Templates</a> @ Templates.com!</div>
				</div>
<!-- footer -->
				<div id="footer">
					<div class="indent">
						<div class="fleft">Designed by: &nbsp;<a href="http://www.templates.com/"><img alt="website templates" title="templates.com - website templates provider" src="images/t-com_logo.gif" /></a> &nbsp;Your provider of &nbsp;<a href="http://www.templates.com/">Website Templates</a></div>
						<div class="fright">Copyright - Type in Your Name</div>
					</div>
				</div>
			</div>
		</div>
